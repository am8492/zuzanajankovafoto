  ...
  return (
    <div className="max-w-3xl mx-auto p-6  rounded-lg shadow-lg">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <label className="text-lg font-semibold text-gray-700">Jméno</label>
          <input
            type="text"
            name="name"
            value={formData.name}
        ...
        <div>
          <label className="text-lg font-semibold text-gray-700">Služba</label>
          <select
            name="service"
          ...
          >
            ...
            <option value="portretniFotofrafie">Portrétní fotografie</option>
